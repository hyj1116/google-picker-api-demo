...
//            b = k;
//            c = b.match(ha);
//            (d = b.match(ia)) && 1 === d.length && ja.test(b) && c && 1 === c.length || N("failed sanity: " + a);
//            return k
//        },
//        ma = function (a, b, c, d) {
//            a = la(a);
...
//            return null
//        },
//        ja = /^https?:\/\/[a-z0-9_.-]+\.google\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/,
//        ia = /\/cb=/g,
//        ha = /\/\//g,
//        na = function () {
//            var a = B();
...
//        return "https://apis.google.com" + ma(a, b, c, d)
//    };
...
//                }
//            },
//            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.zh_TW.9kPBO8qo9Og.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCMLUMqUpUaFDimePH_4p2JxY3YPhA",
