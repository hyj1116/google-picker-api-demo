    ...
    FilePicker.prototype = {
        ...
        open: function () {
            ...
            if (token) {
                ...
                // The user has not yet authenticated with Google We need to do
                // the authentication before displaying the Drive picker.
        ...
        // google.picker.ViewId.DOCUMENTS).setAppId(this.clientId)
        ...
        _showPicker: function () {
            ...
            addView(
                    new google.picker.DocsView().setParent(this.driveURL)
                    .setIncludeFolders(true)).setAppId(this.apiKey)
                .setOAuthToken(accessToken).setCallback(
                    this._pickerCallback.bind(this)).build()
                .setVisible(true);
        },
        ...
        _pickerCallback: function (data) {
            if (data[google.picker.Response.ACTION] == google.picker.Action.PICKED) {
                ...
                document.getElementById("pickupfile").innerHTML = "You searched the \"" +
                    name + "\" file.";
